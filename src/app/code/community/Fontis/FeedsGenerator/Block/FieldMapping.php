...
*/
abstract class Fontis_FeedsGenerator_Block_FieldMapping extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
    /**
    ...
    public function __construct()
    {
        ...
        parent::__construct();
        $this->setTemplate('fontis/feedsgenerator/system/config/form/field/array_dropdown.phtml');
